"""Phase 2 完了時の conftest.py.

第二日分の CSV fixture を追加.
"""
...
@pytest.fixture
def sample_csv_day2(tmp_path: Path) -> Path:
    p = tmp_path / "sales_day2.csv"
    p.write_text(
        "sale_id,product_id,quantity,unit_price,sold_at\n"
        "s-004,p-001,1,1500,2026-05-15T09:00:00+09:00\n"
        "s-005,p-003,2,980,2026-05-15T10:00:00+09:00\n",
        encoding="utf-8",
    )
    return p
